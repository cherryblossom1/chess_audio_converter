...
def piece(piece: chess.Piece, size: Optional[int] = None) -> str:
    ...
    >>> import chess_svg
    >>>
    >>> chess_svg.piece(chess.Piece.from_symbol("R"))  # doctest: +SKIP
...
def board(board: Optional[chess.BaseBoard] = None, *,
    ...
    :param arrows: A list of :class:`~chess_svg.Arrow` objects, like
        ``[chess_svg.Arrow(chess.E2, chess.E4)]``, or a list of tuples, like
    ...
    >>> chess_svg.board(board, squares=squares, size=350)  # doctest: +SKIP
