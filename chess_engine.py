...
def run_in_background(coroutine: Callable[[concurrent.futures.Future[T]], Coroutine[Any, Any, None]], *, name: Optional[str] = None, debug: bool = False, _policy_lock: threading.Lock = threading.Lock()) -> T:
    ...
    Note: This installs a :class:`chess_engine.EventLoopPolicy` for the entire
    process.
    """
...
try:
    ...
    class InfoDict(typing.TypedDict, total=False):
        ...
        Commonly used keys are: ``score`` (a :class:`~chess_engine.PovScore`),
        ...
        ``wdl`` (a :class:`~chess_engine.PovWdl`), and ``string``.
        """
        score: PovScore
        pv: List[chess.Move]
        depth: int
...
class PlayResult:
    """Returned by :func:`chess_engine.Protocol.play()`."""
    ...
    info: InfoDict
    """
    A dictionary of extra :class:`information <chess_engine.InfoDict>`
    sent by the engine, if selected with the *info* argument of
    :func:`~chess_engine.Protocol.play()`.
    """
...
class PovScore:
    """A relative :class:`~chess_engine.Score` and the point of view."""

    relative: Score
    """The relative :class:`~chess_engine.Score`."""
    ...
    def wdl(self, *, model: _WdlModel = "sf", ply: int = 30) -> PovWdl:
        """See :func:`~chess_engine.Score.wdl()`."""
...
class Score(abc.ABC):
    ...
    The score can be :class:`~chess_engine.Cp` (centi-pawns),
    :class:`~chess_engine.Mate` or :py:data:`~chess_engine.MateGiven`.
    A positive value indicates an advantage.

    There is a total order defined on centi-pawn and mate scores.

    >>> from chess_engine import Cp, Mate, MateGiven
    >>>
...
class PovWdl:
    """
    Relative :class:`win/draw/loss statistics <chess_engine.Wdl>` and the point
    of view.
    ...
    relative: Wdl
    """The relative :class:`~chess_engine.Wdl`."""
    ...
    def white(self) -> Wdl:
        """Gets the :class:`~chess_engine.Wdl` from White's point of view."""
        return self.pov(chess.WHITE)



    def black(self) -> Wdl:
        """Gets the :class:`~chess_engine.Wdl` from Black's point of view."""
        return self.pov(chess.BLACK)
    ...
    def pov(self, color: Color) -> Wdl:
        """
        Gets the :class:`~chess_engine.Wdl` from the point of view of the given
        *color*.
        """
        return self.relative if self.turn == color else -self.relative
...
class Protocol(asyncio.SubprocessProtocol, metaclass=abc.ABCMeta):
    ...
    async def configure(self, options: ConfigMapping) -> None:
        ...
        :param options: A dictionary of engine options where the keys are
            names of :data:`~chess_engine.Protocol.options`. Do not set options
            that are managed automatically
            (:func:`chess_engine.Option.is_managed()`).
        """
    ...
    async def play(self, board: chess.Board, limit: Limit, *, game: object = None, info: Info = INFO_NONE, ponder: bool = False, draw_offered: bool = False, root_moves: Optional[Iterable[chess.Move]] = None, options: ConfigMapping = {}) -> PlayResult:
        ...
        :param board: The position. The entire move stack will be sent to the
            engine.
        :param limit: An instance of :class:`chess_engine.Limit` that
        ...
        :param options: Optional. A dictionary of engine options for the
            ...
            with :func:`~chess_engine.Protocol.configure()`.
        """
    ...
    async def analyse(self, board: chess.Board, limit: Limit, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chess.Move]] = None, options: ConfigMapping = {}) -> Union[List[InfoDict], InfoDict]:
        ...
        :class:`information <chess_engine.InfoDict>`.
    ...
    async def analysis(self, board: chess.Board, limit: Optional[Limit] = None, *, multipv: Optional[int] = None, game: object = None, info: Info = INFO_ALL, root_moves: Optional[Iterable[chess.Move]] = None, options: ConfigMapping = {}) -> AnalysisResult:
        ...
        :param board: The position to analyse. The entire move stack will be
            sent to the engine.
        :param limit: Optional. An instance of :class:`chess_engine.Limit`
        ...
        Returns :class:`~chess_engine.AnalysisResult`, a handle that allows
...
class BestMove:
    """Returned by :func:`chess_engine.AnalysisResult.wait()`."""
...
class AnalysisResult:
    ...
    Returned by :func:`chess_engine.Protocol.analysis()`.
    ...
    multipv: List[chess_engine.InfoDict]
    """
    ...
    async def get(self) -> InfoDict:
        ...
        :raises: :exc:`chess_engine.AnalysisComplete` if the analysis is
            complete (or has been stopped) and all information has been
            consumed. Use :func:`~chess_engine.AnalysisResult.next()` if you
    ...
    def empty(self) -> bool:
        ...
        :func:`~chess_engine.AnalysisResult.get()` will return instantly.
        """
...
class SimpleEngine:
    ...
    the same methods and attributes as :class:`chess_engine.Protocol`
    with blocking functions instead of coroutines.

    You may not concurrently modify objects passed to any of the methods. Other
    than that, :class:`~chess_engine.SimpleEngine` is thread-safe. When sending
    ...
    *timeout* seconds longer than expected (unless *timeout* is ``None``).
    ...
    def popen_uci(cls, command: Union[str, List[str]], *, timeout: Optional[float] = 10.0, debug: bool = False, setpgrp: bool = False, **popen_args: Any) -> SimpleEngine:
        """
        Spawns and initializes a UCI engine.
        Returns a :class:`~chess_engine.SimpleEngine` instance.
        """
...
class SimpleAnalysisResult:
    """
    Synchronous wrapper around :class:`~chess_engine.AnalysisResult`. Returned
    by :func:`chess_engine.SimpleEngine.analysis()`.
    """
